...
var
  ...
  list_descarga:array[0..9] of string;
...
type
  tipo_idioma=record
    ...
    avanzado:array[0..13] of string;
    descarga:array[0..10] of string;
  end;
...
const
  ...
  avanzado:('Open','Advanced Configuration','Executable Files','Configuration Files','Main Directories','Images','Read fixed games values','Show all games','DEFAULT VALUES','Show only the available games','Show only the added games','Emulate Joystick','Keyboard','Check game list at startup');
  descarga:('This game is not available. Do you want to download it?','Download extra content with the game','DOWNLOADING','A disk image is required to play Windows 98 games. Do you want to continue?','A disk image is required to play Windows 3.1 games. Do you want to continue?','A disk image is required to play Windows ScummVM games. Do you want to continue?','The game list is not available. Do you want to download it?','There''s an updated version of the game list. Would you like to download it?','Extra content not found. Do you want to download it?','A disk image is required to play Nintendo64 games. Do you want to continue?','The game has been updated. Would you like to download it again?')),
  //Aleman
  ...
  avanzado:('Offen','Erweiterte Konfiguration','Ausführbare Dateien','Konfigurationsdateien','Hauptverzeichnisse','Bilder','Lesen Sie feste Spielwerte','Alle Spiele anzeigen','STANDARDWERTE','Zeige nur die verfügbaren Spiele','Nur die hinzugefügten Spiele anzeigen','Joystick emulieren','Tastatur','Spielliste beim Start überprüfen');
  descarga:('Dieses Spiel ist nicht verfügbar. Möchten Sie es herunterladen?','Lade zusätzliche Inhalte mit dem Spiel herunter','HERUNTERLADEN','Zum Spielen von Windows 98-Spielen muss ein Festplatten-Image heruntergeladen werden. Fortfahren?','Zum Spielen von Windows 3.1-Spielen muss ein Festplatten-Image heruntergeladen werden. Fortfahren?','Zum Spielen von Windows ScummVM-Spielen muss ein Festplatten-Image heruntergeladen werden. Fortfahren?','Die Spieleliste ist nicht verfügbar. Möchten Sie sie herunterladen?','Es gibt eine aktualisierte Version der Spieleliste. Möchten Sie sie herunterladen?','Es wurden keine zusätzlichen Inhalte gefunden. Möchten Sie diese herunterladen?','Zum Spielen von Nintendo64-Spielen muss ein Festplatten-Image heruntergeladen werden. Fortfahren?','Das Spiel wurde aktualisiert. Möchtest du es erneut herunterladen?')),
  //Frances
  ...
  avanzado:('Ouvrir','Configuration Avancée','Fichiers exécutables','Fichiers de configuration','Répertoires Principaux','Images','Lire les valeurs de jeux fixes','Afficher tous les jeux','VALEURS PAR DÉFAUT','Afficher seulement les jeux disponibles','Afficher uniquement les jeux ajoutés','Émuler le joystick','Clavier','Vérifier la liste des jeux au démarrage');
  descarga:('Ce jeu n''est pas disponible. Voulez-vous le télécharger ?','Téléchargez du contenu supplémentaire avec le jeu','TÉLÉCHARGEMENT','Pour jouer aux jeux Windows 98, une image disque doit être téléchargée. Continuer?','Pour jouer aux jeux Windows 3.1, une image disque doit être téléchargée. Continuer ?','Pour jouer aux jeux Windows ScummVM, une image disque doit être téléchargée. Continuer?','La liste des jeux n''est pas disponible. Voulez-vous la télécharger ?','Une version mise à jour de la liste des jeux est disponible. Souhaitez-vous la télécharger ?','Contenu supplémentaire introuvable. Voulez-vous le télécharger ?','Pour jouer aux jeux Nintendo64, une image disque doit être téléchargée. Continuer?','Le jeu a été mis à jour. Voulez-vous le télécharger à nouveau?')),
  //Italiano
  ...
  avanzado:('Apri','Configurazione Avanzata','File Eseguibili','File di configurazione','Directory principali','Immagini','Leggi i valori fissi dei giochi','Mostra tutti i giochi','VALORI PREDEFINITI','Mostra solo i giochi disponibili','Mostra solo i giochi aggiunti','Emula joystick','Tastiera','Controlla l''elenco dei giochi all''avvio');
  descarga:('Questo gioco non è disponibile. Vuoi scaricarlo?','Scarica contenuti extra con il gioco','SCARICAMENTO','Per giocare ai giochi Windows 98 è necessario scaricare un''immagine disco. Continuare?','Per giocare ai giochi Windows 3.1 è necessario scaricare un''immagine disco. Continuare?','Per giocare ai giochi Windows ScummVM è necessario scaricare un''immagine disco. Continuare?','L''elenco dei giochi non è disponibile. Vuoi scaricarlo?','È disponibile una versione aggiornata dell''elenco dei giochi. Desideri scaricarla?','Contenuto aggiuntivo non trovato. Desideri scaricarlo?','Per giocare ai giochi Nintendo64 è necessario scaricare un''immagine disco. Continuare?','Il gioco è stato aggiornato. Vuoi scaricarlo di nuovo?'))
  );
...
begin
  ...
  form1.Checkbox11.caption:=idioma_fijo[idioma_ind].avanzado[13];
  ...
  list_descarga[8]:=idioma_fijo[idioma_ind].descarga[9];
  list_descarga[9]:=idioma_fijo[idioma_ind].descarga[10];
end;
