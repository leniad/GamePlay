...
var
  ...
  list_descarga:array[0..8] of string;
...
const
  ...
  descarga:('This game is not available. Do you want to download it?','Download extra content with the game','DOWNLOADING','A disk image is required to play Windows 98 games. Do you want to continue?','A disk image is required to play Windows 3.1 games. Do you want to continue?','A disk image is required to play Windows ScummVM games. Do you want to continue?','The game list is not available. Do you want to download it?','There''s an updated version of the game list. Would you like to download it?','Extra content not found. Do you want to download it?','A disk image is required to play Nintendo64 games. Do you want to continue?')),
  //Aleman
  ...
  descarga:('Ce jeu n''est pas disponible. Voulez-vous le télécharger ?','Téléchargez du contenu supplémentaire avec le jeu','TÉLÉCHARGEMENT','Pour jouer aux jeux Windows 98, une image disque doit être téléchargée. Continuer?','Pour jouer aux jeux Windows 3.1, une image disque doit être téléchargée. Continuer ?','Pour jouer aux jeux Windows ScummVM, une image disque doit être téléchargée. Continuer?','La liste des jeux n''est pas disponible. Voulez-vous la télécharger ?','Une version mise à jour de la liste des jeux est disponible. Souhaitez-vous la télécharger ?','Contenu supplémentaire introuvable. Voulez-vous le télécharger ?','Pour jouer aux jeux Nintendo64, une image disque doit être téléchargée. Continuer?')),
  //Italiano
