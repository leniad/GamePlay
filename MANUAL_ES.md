...
### 1.7 Información del juego
Aparece la **compañía** y el **año** de publicación.

### 1.8 Manual, guía o mapas
...
- **Programa de Instalación**: Si quieres ejecutar un juego, pero antes necesita ejecutar un programa de instalación, puedes indicarlo aquí y se ejecutará cuando se pulse el boton de setup (Ejemplo: 'Lost Vikings')
...
---
### 4. Jugar en Linux o Mac
Debido a los cambios, la versión de Linux y Mac se encuentra en WIP
